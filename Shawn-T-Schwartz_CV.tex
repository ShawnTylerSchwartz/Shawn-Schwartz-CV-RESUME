...
\begin{document}
	...
	\begin{resume}
		...
		\vspace{1.5mm}
		\\{\it Selected Relevant Coursework:} Computational Theory \& Simulation (A+), Functional Neuroimaging (A+), Evolutionary Medicine (A-) \& Evolutionary Medicine: Clinical Perspective on Psychiatric Disorders (A), Cognitive Development (A-), Perceptual Development (A+), Behavioral Neuroscience (B),  Biology and Social Justice (A+), Cognitive Psychology (A) \& Laboratory (A+), Human Memory (A), Introductory (A+) \& Advanced Topics in MATLAB Programming (A), 1 Year of Calculus \& Linear Algebra (Avg. A-), 1 Year of Calculus Based Physics (Avg. B+), 1 Year of Ecological, Evolutionary, \& Molecular Biology (Avg. B), 2 Years of Calculus Based General \& Organic Chemistry (Avg. B+)
		...
		{\bf Claremont McKenna College}, Keck Science Department of Biology, May 2, 2019 (Upcoming) \\ 
		...
		Principal Investigator: Dr. Jacob Foster
		...
		\begin{itemize} \itemsep 2pt
			...
			\item {\bf Statistical}
				\\ Analysis of variance, correlation, chi-square, regression, hierarchical linear modeling (HLM), Principal Component Analysis (PCA), Independent Component Analysis (ICA), Bayesian Inference, Multidimensional Scaling, K-Means \& Hierarchical Agglomerative Clustering, Dendrogram Analysis
			\item {\bf Laboratory}
