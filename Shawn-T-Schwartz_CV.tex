...
\begin{document}
	...
	\begin{resume}
		...
		\moveleft\hoffset\vbox{\hrule width\resumewidth height 0.25pt}\smallskip
		\vspace{\lowerv}
		Alfaro, M. E., Karan, E. A., {\bf Schwartz, S. T.}, \& Schultz, A. J. (under review). {\it The evolution of color pattern in Butterflyfishes (Chaetodontidae).} Manuscript under review.
		...
		\moveleft\hoffset\vbox{\hrule width\resumewidth height 0.25pt}\smallskip
		\vspace{\lowerv}
		{\bf Schwartz, S. T.}, Siegel, A. L. M., \& Castel, A. D. (upcoming: 2019, May). {\it Risks and rewards: Memory for positive and negative item-location associations.} To Be Presented at the 28th Annual UCLA Psychology Undergraduate Research Conference in Los Angeles, CA. May 10. \\
		
		{\bf Schwartz, S. T.}, Siegel, A. L. M., \& Castel, A. D. (upcoming: 2019, May). {\it Memory for positive and negative item-location associations.} To Be Presented at Psi Chi Whittier College's 17th Annual Undergraduate Research Conference in Whittier, CA. May 4.
		...
		{\bf UCLA}, Department of Psychology Honors Seminar, May 1, 2019 (Upcoming) \\
