	...
	\begin{resume}
		...
		\begin{itemize} \itemsep 2pt
			\item {\bf Programming} 
				...
				\\ {\sl Currently learning} Machine Learning: CoreML, TensorFlow
		...
		\begin{itemize} \itemsep -2pt
			...
			\item {\bf Total Volunteered Hours: 432 hours.}
		\end{itemize}
		...
		\begin{itemize} \itemsep -2pt
			\item Shadow out-patient surgeons, radiology technicians for in-patient and emergency department cases, and check-in patients for early-morning surgeries in admissions.
			...
			\item {\bf Total Volunteered Hours: 691 hours.}
		\end{itemize}
		...
		\begin{itemize} \itemsep -2pt
			\item Built an international network in over four countries of thousands of children and adults through website outreach and social media campaigns. Main Sponsor: {\bf Nancy Cartwright} (Voice of Bart Simpson from {\bf \it The Simpsons}). \textcolor{RoyalBlue}{\url{https://backoffbully.org}}
		\end{itemize}
