	...
	\begin{resume}
		...
		\begin{itemize} \itemsep 2pt
			\item {\bf Programming} 
				...
				\\ {\sl Proficient in} R, Swift, MySQL, Ruby, JSON, jQuery, Python, AngularJS, Node.js
				\\ {\sl Other Libraries \& Tools:} jsPsych, Collector, Psychtoolbox, Jekyll, Jmol, JSmol, p5.js
				\\ {\sl Currently learning} Machine Learning: Apple Core ML, TensorFlow, Keras
		...
		\begin{itemize} \itemsep -2pt
			...
			\item {\bf Total Volunteered Hours: 710 hours.}
		\end{itemize}
