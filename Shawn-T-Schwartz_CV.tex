...
\begin{document}
	...
	\begin{resume}
		...
		\vspace{-0.1mm}
		\hspace{0.25cm} Degree Honors: Highest Departmental Honors \\
		\vspace{0.01mm}
		\hspace{0.25cm} Honors Thesis: {\it Risks and rewards: Memory for positive and negative item-location associations. } \\
		\vspace{0.01mm}
		\hspace{0.17cm} Primary Advisor: Dr. Alan D. Castel
		\vspace{2.5mm}
		\\ {\sl Bachelor of Science (B.S.)}, Biology, {\it Specialization in Computing} \\
		\vspace{-0.1mm}
		\hspace{0.25cm}  Degree Honors: Departmental Honors \\
		\vspace{0.01mm}
		\hspace{0.25cm} Honors Thesis: {\it The evolution of color pattern in Butterflyfishes (Chaetodontidae).} \\
		\vspace{0.01mm}
